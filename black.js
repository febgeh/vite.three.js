...
const spaceTexture1 = new THREE.TextureLoader().load('bilder/space6.jpg');

let blackHoleGeom = new THREE.SphereGeometry(900, 128, 128)
let blackHoleMat = new THREE.MeshPhongMaterial({map: spaceTexture1});
blackHoleMat.side = THREE.BackSide
let blackHole = new THREE.Mesh(blackHoleGeom, blackHoleMat);
blackHole.position.set(0,0,-1000)
scene.add(blackHole)
...
sphereRedG.position.setX(-24)
sphereRedGS.position.setX(26)
...
function moveCamera(){
  ...
  blackHole.position.z= -1000 + t * 0.07;
